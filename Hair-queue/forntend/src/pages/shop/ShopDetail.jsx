...
import { FaMapMarkerAlt, FaPhone, FaClock, FaCut, FaUsers, FaStar, FaArrowLeft, FaCalendarPlus, FaUserCheck } from 'react-icons/fa';
...
const ShopDetail = () => {
  ...
  const handleNextCustomer = async () => {
    ...
    try {
      const response = await queueService.nextCustomer(id);
      if (response.success) {
              ...
              {isOwner ? (
                <>
                  ...
                  <Link
                    ...
                    className="px-6 py-3 bg-white text-blue-600 rounded-lg font-medium hover:bg-gray-100 text-center"
                  >
                    Edit Shop
                  </Link>
                </>
                  ...
                  <div className="flex items-center">
                    <div className="h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center mr-4">
                      {shop.owner?.avatar ? (
                        ...
                        <FaUserCheck className="h-6 w-6 text-gray-400" />
                      )}
                    </div>
                    <div>
                      <p className="font-medium text-gray-900">{shop.owner?.fullName}</p>
